...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, prefix + "/individual-entity").hasAuthority("CAN_SELECT")
                .antMatchers(HttpMethod.PUT, prefix + "/individual-entity").hasAuthority("CAN_UPDATE")
                .antMatchers(HttpMethod.POST, prefix + "/individual-entity").hasAuthority("CAN_INSERT")
                .antMatchers(HttpMethod.DELETE, prefix + "/individual-entity").hasAuthority("CAN_DELETE")
